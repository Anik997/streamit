...
<head>
      ...
      <title>Streamit Admin | Login</title>
      <!-- Favicon -->
                  ...
                  <div class="sign-user_card ">                    
                     <div class="sign-in-page-data">
                        <div class="sign-in-from w-100 m-auto">
                           ...
                           @include('admin.helper.login_message')
                        <form class="mt-4" action="{{ route('admin.login.submit') }}" method="post">
                              @csrf
                              <div class="form-group">                                 
                                 <input type="text" class="form-control mb-0" placeholder="Enter email" name="email">
                              </div>
                              <div class="form-group">                                 
