                           ...
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0">
                                 ...
                                 <a href="#" class="iq-sub-card" >
                                    <div class="media align-items-center">
                                       <div class="">
                                          <img class="avatar-40 rounded" src="{{asset('assets/backend/assets/images/user/02.jpg')}}" alt="">
                                       </div>
                                       <div class="media-body ml-3">
                                 ...
                                 <a href="#" class="iq-sub-card" >
                                    <div class="media align-items-center">
                                       <div class="">
                                          <img class="avatar-40 rounded" src="{{asset('assets/backend/assets/images/user/03.jpg')}}" alt="">
                                       </div>
                                       <div class="media-body ml-3">
                                 ...
                                 <a href="#" class="iq-sub-card" >
                                    <div class="media align-items-center">
                                       <div class="">
                                          <img class="avatar-40 rounded" src="{{asset('assets/backend/assets/images/user/04.jpg')}}" alt="">
                                       </div>
                                       <div class="media-body ml-3">
                           ...
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0 ">
                                 ...
                                 <a href="#" class="iq-sub-card">
                                    <div class="media align-items-center">
                                       <div class="">
                                          <img class="avatar-40 rounded" src="{{asset('assets/backend/assets/images/user/05.jpg')}}" alt="">
                                       </div>
                                       <div class="media-body ml-3">
                     ...
                     <li class="line-height pt-3">
                        ...
                        <div class="iq-sub-dropdown iq-user-dropdown">
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0 ">
                                 <div class="bg-primary p-3">
                                    <h5 class="mb-0 text-white line-height">{{Auth::guard('admin')->user()->name}}</h5>
                                 ...
                                 <div class="d-inline-block w-100 text-center p-3">
                                   ...
                                   document.getElementById('logout-form-admin').submit();">Sign out<i class="ri-login-box-line ml-2"></i></a>
