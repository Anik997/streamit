 <section id="home" class="iq-main-slider p-0">
         <div id="home-slider" class="slider m-0 p-0">
            @php
               $sliders=App\Models\admin\Slider::where('type','1')->latest()->get();
            @endphp
            @if (count($sliders)>0)
           @foreach ($sliders as $slider)
             
            <div class="slide slick-bg" style="background-image: url({{ asset('assets/backend/slider/'.$slider->slider_image) }});">
