         ...
         <div class="col-sm-12 overflow-hidden">
            ...
            <div class="favorites-contens">
               <ul class="favorites-slider list-inline  row p-0 mb-0">
                  ...
                  <li class="slide-item">
                     <a href="{{ route('movie.show.detail',$movie->slug) }}">
                        <div class="block-images position-relative">
                           <div class="img-box">
                              <img src="{{asset('assets/backend/video/store/thumbnail/small/'.$movie->thumbnail)}}" class="img-fluid" alt="">
                           </div>
                           <div class="block-description">
                              <h6>{{$movie->name}}</h6>
                              <div class="movie-time d-flex align-items-center my-2">
                                 <div class="badge badge-secondary p-1 mr-2">{{$movie->view}}</div>
